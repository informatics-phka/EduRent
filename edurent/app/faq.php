				...
				<div id="collapse1" class="collapse" aria-labelledby="heading1" data-parent="#accordion">
					<div class="card-body">
						<ul>
							...
							<li class="mb-2">enter a device name, a device info and a device indentificator. If you like, you can upload a image</li>
							<li class="mb-2">finish the device type creation by clicking on "Confirm"</li>
						</ul>
					</div>
				</div>
			</div>
